			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"removeUser".equals(type)) {
							...
							return (RemoveUser) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "args0")
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setArgs0(es.upm.etsiinf.sos.model.xsd.Username.Factory.parse(reader));
