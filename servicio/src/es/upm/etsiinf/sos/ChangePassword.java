...
public class ChangePassword implements org.apache.axis2.databinding.ADBBean {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				...
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "changePassword", xmlWriter);
			}
		...
		if (localArgs0Tracker) {
			if (localArgs0 == null) {
				...
				localArgs0.serialize(new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "args0"), xmlWriter);
			}
		}
		xmlWriter.writeEndElement();
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localArgs0Tracker) {
			elementList.add(new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "args0"));
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"changePassword".equals(type)) {
							...
							return (ChangePassword) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "args0")
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.setArgs0(es.upm.etsiinf.sos.model.xsd.PasswordPair.Factory.parse(reader));
