...
public class User implements org.apache.axis2.databinding.ADBBean {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localNameTracker) {
			elementList.add(new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "name"));

			elementList.add(localName == null ? null
					: org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localName));
		}
		if (localPwdTracker) {
			elementList.add(new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "pwd"));
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"User".equals(type)) {
							...
							return (User) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue) && !"1".equals(nillableValue)) {
						...
						object.setPwd(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
