...
public class Username implements org.apache.axis2.databinding.ADBBean {
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		if (localUsernameTracker) {
			elementList.add(new javax.xml.namespace.QName("http://model.sos.etsiinf.upm.es/xsd", "username"));
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Username".equals(type)) {
							...
							return (Username) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
