			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"logoutResponse".equals(type)) {
							...
							return (LogoutResponse) es.upm.etsiinf.sos.model.xsd.ExtensionMapper.getTypeObject(nsUri,
									type, reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "return")
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.set_return(es.upm.etsiinf.sos.model.xsd.Response.Factory.parse(reader));
