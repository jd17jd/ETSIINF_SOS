...
public class WineSocialUPMMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
		...
		try {
			...
			if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils
				...
				if ("getMyFollowers".equals(methodName)) {
					...
					es.upm.etsiinf.sos.GetMyFollowers wrappedParam = (es.upm.etsiinf.sos.GetMyFollowers) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(),
							es.upm.etsiinf.sos.GetMyFollowers.class, getEnvelopeNamespaces(msgContext.getEnvelope()));

					getMyFollowersResponse57 =

							skel.getMyFollowers(wrappedParam);

					envelope = toEnvelope(getSOAPFactory(msgContext), getMyFollowersResponse57, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "getMyFollowers"));
				} else
				...
				if ("removeUser".equals(methodName)) {
					...
					es.upm.etsiinf.sos.RemoveUser wrappedParam = (es.upm.etsiinf.sos.RemoveUser) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.RemoveUser.class,
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), removeUserResponse59, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "removeUser"));
				} else

				if ("addFollower".equals(methodName)) {

					es.upm.etsiinf.sos.AddFollowerResponse addFollowerResponse61 = null;
					es.upm.etsiinf.sos.AddFollower wrappedParam = (es.upm.etsiinf.sos.AddFollower) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.AddFollower.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), addFollowerResponse61, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "addFollower"));
				} else
				...
				if ("logout".equals(methodName)) {
					...
					es.upm.etsiinf.sos.Logout wrappedParam = (es.upm.etsiinf.sos.Logout) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.Logout.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), logoutResponse63, false,
				...
				if ("removeWine".equals(methodName)) {
					...
					es.upm.etsiinf.sos.RemoveWine wrappedParam = (es.upm.etsiinf.sos.RemoveWine) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.RemoveWine.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), removeWineResponse65, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "removeWine"));
				} else

				if ("getMyRates".equals(methodName)) {

					es.upm.etsiinf.sos.GetMyRatesResponse getMyRatesResponse67 = null;
					es.upm.etsiinf.sos.GetMyRates wrappedParam = (es.upm.etsiinf.sos.GetMyRates) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.GetMyRates.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), getMyRatesResponse67, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "getMyRates"));
				} else

				if ("unfollow".equals(methodName)) {

					es.upm.etsiinf.sos.UnfollowResponse unfollowResponse69 = null;
					es.upm.etsiinf.sos.Unfollow wrappedParam = (es.upm.etsiinf.sos.Unfollow) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.Unfollow.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), unfollowResponse69, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "unfollow"));
				} else
				...
				if ("addUser".equals(methodName)) {
					...
					es.upm.etsiinf.sos.AddUser wrappedParam = (es.upm.etsiinf.sos.AddUser) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.AddUser.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), addUserResponse71, false,
				...
				if ("rateWine".equals(methodName)) {
					...
					es.upm.etsiinf.sos.RateWine wrappedParam = (es.upm.etsiinf.sos.RateWine) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.RateWine.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), rateWineResponse73, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "rateWine"));
				} else

				if ("addWine".equals(methodName)) {

					es.upm.etsiinf.sos.AddWineResponse addWineResponse75 = null;
					es.upm.etsiinf.sos.AddWine wrappedParam = (es.upm.etsiinf.sos.AddWine) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.AddWine.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), addWineResponse75, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "addWine"));
				} else

				if ("getWines".equals(methodName)) {

					es.upm.etsiinf.sos.GetWinesResponse getWinesResponse77 = null;
					es.upm.etsiinf.sos.GetWines wrappedParam = (es.upm.etsiinf.sos.GetWines) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.GetWines.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), getWinesResponse77, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "getWines"));
				} else
				...
				if ("changePassword".equals(methodName)) {
					...
					es.upm.etsiinf.sos.ChangePassword wrappedParam = (es.upm.etsiinf.sos.ChangePassword) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(),
							es.upm.etsiinf.sos.ChangePassword.class, getEnvelopeNamespaces(msgContext.getEnvelope()));

					changePasswordResponse79 =

							skel.changePassword(wrappedParam);

					envelope = toEnvelope(getSOAPFactory(msgContext), changePasswordResponse79, false,
				...
				if ("login".equals(methodName)) {
					...
					es.upm.etsiinf.sos.Login wrappedParam = (es.upm.etsiinf.sos.Login) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(), es.upm.etsiinf.sos.Login.class,
							getEnvelopeNamespaces(msgContext.getEnvelope()));
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), loginResponse81, false,
				...
				if ("getMyFollowerRates".equals(methodName)) {
					...
					es.upm.etsiinf.sos.GetMyFollowerRates wrappedParam = (es.upm.etsiinf.sos.GetMyFollowerRates) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(),
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), getMyFollowerRatesResponse83, false,
							new javax.xml.namespace.QName("http://sos.etsiinf.upm.es", "getMyFollowerRates"));
	...
	private org.apache.axiom.om.OMElement toOM(es.upm.etsiinf.sos.GetMyFollowerRatesResponse param,
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			...
			emptyEnvelope.getBody()
					.addChild(param.getOMElement(es.upm.etsiinf.sos.GetMyFollowersResponse.MY_QNAME, factory));
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.RemoveWineResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.GetMyRatesResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.UnfollowResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.RateWineResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.AddWineResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
			es.upm.etsiinf.sos.GetWinesResponse param, boolean optimizeContent, javax.xml.namespace.QName methodQName)
			throws org.apache.axis2.AxisFault {
		try {
			org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			...
			emptyEnvelope.getBody()
					.addChild(param.getOMElement(es.upm.etsiinf.sos.GetMyFollowerRatesResponse.MY_QNAME, factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
		...
		try {
			...
			if (es.upm.etsiinf.sos.GetMyFollowersResponse.class.equals(type)) {
				...
				return es.upm.etsiinf.sos.GetMyFollowersResponse.Factory
			...
			if (es.upm.etsiinf.sos.GetMyFollowerRatesResponse.class.equals(type)) {
				...
				return es.upm.etsiinf.sos.GetMyFollowerRatesResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
