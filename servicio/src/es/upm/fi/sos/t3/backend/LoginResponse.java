...
public class LoginResponse implements org.apache.axis2.databinding.ADBBean {
	...
	protected es.upm.fi.sos.t3.backend.xsd.LoginResponseBackEnd local_return;
	 ...
	 * 
	 * @return es.upm.fi.sos.t3.backend.xsd.LoginResponseBackEnd
	 */
	public es.upm.fi.sos.t3.backend.xsd.LoginResponseBackEnd get_return() {
		return local_return;
	}
	 ...
	 * @param param _return
	 */
	public void set_return(es.upm.fi.sos.t3.backend.xsd.LoginResponseBackEnd param) {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"loginResponse".equals(type)) {
							...
							return (LoginResponse) es.upm.fi.sos.t3.backend.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
						...
						object.set_return(es.upm.fi.sos.t3.backend.xsd.LoginResponseBackEnd.Factory.parse(reader));
