...
public class ExistUser implements org.apache.axis2.databinding.ADBBean {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"existUser".equals(type)) {
							...
							return (ExistUser) es.upm.fi.sos.t3.backend.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
